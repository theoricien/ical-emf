...
import xCalendar.formatting2.MyDslFormatter;
import xCalendar.generator.MyDslGenerator;
import xCalendar.parser.antlr.MyDslAntlrTokenFileProvider;
import xCalendar.parser.antlr.MyDslParser;
import xCalendar.parser.antlr.internal.InternalMyDslLexer;
import xCalendar.scoping.MyDslScopeProvider;
import xCalendar.serializer.MyDslSemanticSequencer;
import xCalendar.serializer.MyDslSyntacticSequencer;
import xCalendar.services.MyDslGrammarAccess;
import xCalendar.validation.MyDslConfigurableIssueCodesProvider;
import xCalendar.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "xCalendar/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("xCalendar.MyDsl");
	}
